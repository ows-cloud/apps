...
StreetAddress, PostalAddress, BillingAddress, ShipToAddress, ShipFromAddress.""",
    ...
    "DebitCreditIndicatorType": SimpleTypeDescriptor(
    ...
    "DebitCreditIndicatorType8": SimpleTypeDescriptor(
        "DebitCreditIndicatorType8",
        "SAFcodeType",
        [("D", "D"), ("C", "C")],
        """Indicates whether the amounts on line-level are debit or credit amounts. Entry must correspond to entry reflected in General Ledger Entry. Signing of lineamounts is relative to this indicator. E.g. a return can lead to a negative amount.""",
    ),
    "SAFlongtextType": SimpleTypeDescriptor("SAFlongtextType", "string"),
    "DescriptionType": SimpleTypeDescriptor(
        "DescriptionType",
        "SAFlongtextType",
    ...
    "PeriodEndYearType": SimpleTypeDescriptor(
        "PeriodEndYearType", "nonNegativeInteger"
    ),
    "PeriodStartYearType": SimpleTypeDescriptor(
        "PeriodStartYearType", "nonNegativeInteger"
    ),
    ...
    "StatusType": SimpleTypeDescriptor(
        "StatusType",
        "SAFmiddle1textType",
        [
            ("Active", "Active"),
...
Active, Closed, Observation, Passive.""",
    ...
    "StatusType11": SimpleTypeDescriptor(
        "StatusType11",
        "SAFmiddle1textType",
...
The only valid value is “Skatteetaten ”.""",
    ...
    "TaxTypeType": SimpleTypeDescriptor(
        "TaxTypeType",
        "SAFcodeType",
        [("MVA", "MVA")],
        """Tax type for look-up in tables. “MVA” is the only valid value.""",
    ),
    "TaxTypeType12": SimpleTypeDescriptor(
        "TaxTypeType12",
        "SAFcodeType",
        [("MVA", "MVA")],
